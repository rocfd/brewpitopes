...
dir.create(paste0(argv$path, "/", "brewpitopes", "/", "B_structural_predictions/pdb", sep = ""))
dir.create(paste0(argv$path, "/", "brewpitopes", "/", "B_structural_predictions/alphafold", sep = ""))
dir.create(paste0(argv$path, "/", "brewpitopes", "/", "B_structural_predictions/pdbrenum", sep = ""))
